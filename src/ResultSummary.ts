...
//
//   const resultSummary = Convert.toResultSummary(json);
//
...
export class Convert {
  public static toResultSummary(json: string): ResultSummary {
    return cast(JSON.parse(json), r('ResultSummary'));
  }

  public static resultSummaryToJson(value: ResultSummary): string {
    return JSON.stringify(uncast(value, r('ResultSummary')), null, 2);
  }
}
